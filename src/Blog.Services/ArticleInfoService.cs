...
{
    public class ArticleInfoService : BaseService<ArticleInfo>, IArticleInfoService
    {
        IArticleInfoRepository _articleInfoRepository;
        public ArticleInfoService(IArticleInfoRepository articleInfoRepository) : base(articleInfoRepository)
        {
