...
{
    public class SysAccountService : BaseService<SysAccount>, ISysAccountService
    {
        ISysAccountRepository _sysAccountRepository;
        ISysUserService _sysUserService;
        public SysAccountService(ISysAccountRepository sysAccountRepository, ISysUserService sysUserService) : base(sysAccountRepository)
        {
