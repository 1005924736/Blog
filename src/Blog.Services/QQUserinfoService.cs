...
{
    public class QQUserinfoService : BaseService<QQUserinfo>, IQQUserinfoService
    {
        IQQUserinfoRepository _qQUserinfoRepository;
        public QQUserinfoService(IQQUserinfoRepository qQUserinfoRepository) : base(qQUserinfoRepository)
        {
