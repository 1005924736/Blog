...
namespace Blog.Web.Areas.SystemManage.Controllers
{
    ...
    public class ModuleController : BaseControler
    {
        ...
        public ModuleController(ISysModuleService sysModuleService, ISysPermissionService sysPermissionService)
        {
        ...
        public ActionResult Form(SysModule module)
        {
            ...
            return Json(_sysModuleService.Save(module));
        }
        ...
        {
            var menu = _sysModuleService.FindEntity(key);
        ...
        {
            return Json(await _sysPermissionService.GetMenuAndButton(CurrentUser.RoleId));
        }
